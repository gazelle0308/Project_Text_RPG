...
Monster::Monster::Monster(std::string name, int hp, int power, int defence, std::string skill, int expReward): name(name), hp(hp), power(power), defence(defence), skill(skill), expReward(expReward){}
...
int Monster::GetExpReward() const{ return this->expReward; }
...
void Monster::SetExpReward(int expReward){ this->expReward = expReward; }
